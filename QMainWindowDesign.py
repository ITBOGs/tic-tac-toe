...
"}")
        ...
        self.scene.setMinimumSize(QtCore.QSize(0, 200))
        self.scene.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.verticalLayout.addWidget(self.scene, 0, QtCore.Qt.AlignTop)
